...
INSERT INTO `apikeys` VALUES (14,3,'WFN)(;$_P7E{BK^;(XX*E$>V{J^~CEPKD!@)@ZU2VW(O@XK}^LZ{+£C)Z3M8T)2'),(15,4,'<(P;9CS5$SNKP%O%RJ^>N+BOMTEU8_*5G(LP%O*6MXW$^>N+DW*IFEHV56LUJ!SV');
...
-- Dump completed on 2020-03-17  3:00:11
